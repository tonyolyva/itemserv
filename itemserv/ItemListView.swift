...
var body: some View {
    NavigationStack {
        ...
        // Hidden NavigationLink for scanned item navigation
        scannerNavigationLink
    }
}
...
private var scannerNavigationLink: some View {
    NavigationLink(
...
private var contentView: some View {
    if allItems.isEmpty {
        ...
        VStack(spacing: 10) {
            ...
            .pickerStyle(.segmented)
            .padding(.horizontal)
            .onChange(of: filterSelection) { newValue in
